...
const Hero = () => {
  return (
    <div className="hero-section ">
      <section className="grid max-w-7xl mx-auto lg:grid-cols-2 place-items-center py-20 md:py-32 gap-10 ">
        <div className="text-center lg:text-start space-y-6">
          <main className="text-5xl md:text-6xl font-bold text-balance">
            <h1 className="inline">
              <span className="inline bg-linear-to-r from-[#667EEA] to-[#764BA2] text-transparent bg-clip-text">
                Stripe
              </span>{" "}
              Course with
            </h1>{" "}
